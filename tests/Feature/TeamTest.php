...
test('can shorten link', function () {
    ...
    $create = $cuttly->team()->noTitle()->public()->name('john' . mt_rand())->shorten($this->link);
...
test('can edit link', function () {
    ...
    $create = $cuttly->team()->noTitle()->public()->name('john1' . mt_rand())->shorten($this->link);
...
test('can delete link', function () {
    ...
    $create = $cuttly->team()->noTitle()->public()->name('john2' . mt_rand())->shorten($this->link);
...
test('can get stats', function () {
    ...
    $create = $cuttly->team()->noTitle()->public()->name('john3' . mt_rand())->shorten($this->link);
